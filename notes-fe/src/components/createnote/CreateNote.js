...
export default class CreateNote extends React.Component {
    constructor() {
        super()
        this.state = {
            id: "", title: "", content: "", noteTags: [], tags: [], selectedTag: "",
            titleError: "Title is a mandatory field", contentError: "Content is a mandatory field"
        }
    }
